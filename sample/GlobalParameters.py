...
PHASE_3_PATH2 = [Point(440, 735, angle=45), Point(360, 735, angle=120)]
PHASE_3_SPEED = 2.58 * FRAME_RATE
PHASE_3_INITIAL_SPEED = 0.3 * FRAME_RATE

PHASE_4_SPEED = 1 * FRAME_RATE
